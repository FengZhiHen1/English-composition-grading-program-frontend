    ...
    content: [
      {
        point: "情感转变自然",
        evidence:
          "从'David wouldn't look at me'到'eyes sharpened, I'm ready'，刻画了David从自卑到重拾信心的过程。",
      },
    ],
    language: [
      {
        point: "尝试使用高级词汇与修辞",
        evidence:
          "使用了'glimpsed', 'anxious and frustrated', 'flood of excitement', 'eyes sharpened'等表达，增强了画面的生动性。",
      },
    ],
    structure: [
      {
    ...
    content: [
      {
        point: "结尾完整性",
        description:
          "第二段明显未写完，缺乏对David奔跑过程的具体描写以及比赛结束后的反应，这是续写的重要部分。",
      },
    ],
    language: [
      {
        point: "消除中式英语",
        evidence:
          "原文'light up his moud' (点亮心情?) 和 'judge shot' (裁判开枪?) 需要转换为地道的英语表达。",
      },
      {
        point: "基础拼写与语法",
    ...
    structure: [
      {
        point: "动作描写的连贯性",
        description:
          "第二段起跑时的描写略显生硬，'except David'的位置安排让句子显得头重脚轻。",
      },
    ],
  },
  error_summary: {
    ...
    spelling: ["efforst -> efforts", "moud -> mood"],
    structure: ["搭配不当 (light up mood, judge shot)"],
  },
  detailed_errors: [
    {
      id: 1,
      ...
      advanced_suggestion:
        "I attempted to communicate with him gently and patiently...",
    },
    {
      id: 2,
      type: "拼写错误",
      ...
      explanation:
        "'efforst' 拼写错误，应为 'efforts'；'moud' 拼写错误，应为 'mood'；且 'light up his mood' 搭配不地道，常用 'lift his spirits' 或 'cheer him up'。",
    ...
    },
    {
      ...
      type: "搭配不当",
      original_sentence:
        "a flood of excitement and hope streamed in David's heart",
      correction: "a flood of excitement and hope surged through David",
      explanation:
        "'streamed in... heart' 表达略显中式，情感涌动常用 'surged through' 或 'welled up in'。",
    ...
    },
    {
      ...
      explanation:
        "'judge shot' 直译自中文“裁判开枪”，语境不当（像是在射击）。比赛开始应指枪响。",
    ...
    },
    {
      ...
      explanation:
        "主语 'runners' 是复数，喻体 'arrow' 也应对应复数，或者使用 'shot out like an arrow from a bow' (作为整体动作)。",
  ...
  optimizations: [
    {
      ...
      type: "句式升级",
      original_sentence:
        "David glimpsed at me and lowered his head, seeming anxious and frustrated.",
      correction:
        "David stole a glance at me before burying his head in his hands, a mixture of anxiety and frustration written all over him.",
      explanation:
        "原句表达清楚但略显平淡。升格后增加了动作细节（burying his head）和神态描写（written all over him），更具画面感。",
    },
    {
      id: 2,
      type: "句式升级",
      ...
      correction:
        'He stood up, a newfound determination gleaming in his eyes. "I\'m ready," he declared firmly.',
      explanation:
        "将单纯的 'sharpened' 改为 'newfound determination gleaming'，并增加了说话的语气 'declared firmly'，增强了人物的坚定感。",
    },
  ],
  paragraph_reviews: [
    {
    ...
    },
    {
      ...
      issues:
        "出现了典型的中式英语表达（judge shot），且段落未完成，句子中断。",
      specific_corrections: [
        {
          wrong: "judge shot",
    ...
    applicable_themes: [
      {
        ...
        description:
          "适用于描写人物面对身体缺陷或心理障碍时，在他人鼓励下重拾信心的场景。",
      },
      {
