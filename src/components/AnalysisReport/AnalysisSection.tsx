                ...
                {(points as HighlightPoint[]).map((p, i) => (
                  <li key={i}>
                    <div className="flex gap-2.5">
                      <Star
                        size={12}
                        className="text-yellow-400 shrink-0 mt-1 fill-yellow-400"
                      />
                      <div>
      ...
      <div className="bg-stone-900 rounded-xl shadow-lg p-6 text-white overflow-hidden relative">
        ...
        <div className="flex flex-col gap-6 relative z-10">
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              {data.material_reuse_guide.applicable_themes.map((t, i) => (
                <div
                  key={i}
                  className="bg-stone-800/50 p-2.5 rounded border border-stone-800"
                >
                  <span className="block font-bold text-xs text-yellow-100 mb-1">
                    {t.theme}
                  </span>
          ...
          <div className="grid grid-cols-1 gap-4">
            <div>
              <h4 className="text-stone-500 text-[10px] font-bold uppercase tracking-widest mb-2">
                Direction
              </h4>
